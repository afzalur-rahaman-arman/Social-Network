			...
			if ($check_unameMail_num >= 1) {
				$chengePass_cnfrm = "
							<form action='confirmationPass.php?u=".$unameMail."&code=".$uCodeMail."' method='POST'>
								<p>Change Your Social Network Password!</p></br>
				...
				if ($newpassword == $repear_password) {
					...
					if (mysql_query($updatePassQuery)) {
						...
						$msg = "Assalamu Alaikum  ".$get_first_nm_fetch_query."
								successfully your Social Network password has been changed.
								";
						mail($get_email_fetch_query,"Social Network Password Changed",$msg, "From:Social Network <no-reply@daowat.com>");
					}else {
					...
					if (isset($chengePass_cnfrm)) {
						...
						echo '
							<form action="passRecover.php" method="POST">
								<p>Find your Social Network account!</p></br>
