		...
		<div style="width: 900px; margin: 52px auto;">
				...
				<div class="homeLeftSideContent" >
					<div class="home_cov" style= "background: url(<?php echo $cover_pic; ?>) repeat center center;">
						...
						<div class="homenavemanu">
							<div >
								<div ><a href="index.php">Social Network</a></div>
			...
			<div style="float: right;">
				 <div class="notificationbox">
				 	</a><a href="notifications.php"><h2 style="float: left; color: #848684;">Social Network Notification&nbsp;</h2></a><a href="notification.php"><h2  style="float: left; color: #0B810B;">|&nbsp;Post Notification</h2>
				 			...
				 			<li style='line-height: 8px;'>
				 				<?php 
									...
									$count_notipost = mysql_num_rows($get_notipost);
				 					//getting Social Network comment
